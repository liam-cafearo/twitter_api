...
edi_trends = api.trends_place(EDI_WOE_ID)
...
edi_trends_set = set([trend['name']
                    for trend in edi_trends[0]['trends']])

common_trends = set.intersection(dub_trends_set, lon_trends_set, edi_trends_set)
